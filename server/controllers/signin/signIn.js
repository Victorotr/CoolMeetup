...
export const SignIn = async (req, res) => {
    ...
    try {
        ...
        const [user] = await connection.query('SELECT id_user as id,user_name as username,user_password as pwd,user_bio as bio,active,google_registered,picture_url FROM users WHERE user_email =?', [email]);
