...
export const postMeetup = async (req, res, next) => {
  ...
  try {
    ...
    const meetupObject = {
      ...
      image:req.file?  process.env.IMAGE_URL +req.file.originalname + '/Meetup' : null
    }
    try {
