  ...
  return (
    <div
      className={`${toast.text ? "flex" : "hidden"} ${
        ...
        toast.type
      }  ${toastType === 'warning' ? 'border-amber-600/50' : toastType === 'error' ? 'border-red-500/50' : 'border-blue-500/50' } text-sm items-center justify-between gap-2 z-50 fixed p-2 rounded-md shadow-xl top-12 w-96 bg-zinc-50 left-0 right-0 mx-auto border-2 `}
    >
